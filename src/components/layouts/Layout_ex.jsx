...
export default function Layout_ex() {
  ...
  const handleAlert = (type) => {
    ...
    if (type === "scs") {
      setVariables(
        "Mensaje de success - Ej: Se produjeron los cambios con éxito!",
        "success"
      );
    ...
    if (type === "info") {
      setVariables(
        "Mensaje de Información - Ej: Nuevos usuarios registrados",
        "info"
      );
      ...
      <Box>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={6}>
            ...
            >
              <Typography variant="h6">
                Col 1 - Size 6 - Color verde claro
              </Typography>
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            ...
            >
              <Typography variant="h6">
                Col 2 - Size 6 - Color naranja oscuro
              </Typography>
            </Paper>
          </Grid>
          <Grid item xs={12} md={12}>
            ...
            >
              <Typography variant="h6">
                Col 1 - Size 12 - Color verde intermedio
              </Typography>
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} md={3}>
            ...
            >
              <Typography sx={(theme) => theme.typography.parrafos}>
                Este es texto parrafo personalizado. Este es texto parrafo
                personalizado. Este es texto parrafo personalizado. Este es
                texto parrafo personalizado. Lorem
              </Typography>
            </Paper>
          </Grid>
          <Grid item xs={12} md={3}>
